...
import {Booking, Listing, ListingType, User} from "../src/types";
...
const listings: Listing[] = [
    {
        ...
        image: "https://via.placeholder.com/1950x1300.png",
...
const users: User[] = [
    {
        ...
        token: "token_************",
        name: "James J.",
        avatar: "https://via.placeholder.com/500.png",
        contact: "james@wanderung.com",
        walletId: "acct_************",
        income: 723796,
        bookings: [],
        listings: [
    ...
    },
    {
        ...
        name: "Elizabeth A.",
        avatar: "https://via.placeholder.com/500.png",
        contact: "elizabeth@wanderung.com",
        walletId: "acct_************",
        income: 256144,
        bookings: [],
        listings: [
    ...
    },
    {
        ...
        name: "Danielle C.",
        avatar: "https://via.placeholder.com/500.png",
        contact: "danielle@wanderung.com",
        walletId: "acct_************",
        income: 465043,
        bookings: [],
        listings: [
